...
public:
    ...
    void push_task(FuncType f, int* array, const std::size_t size);
...
public:
    ...
    void push_task(FuncType f, int* array, const std::size_t size);//дублирует push_task
private:
    // пул потоков
